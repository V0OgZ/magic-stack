...
# 🌀 AVALON - Script de Validation Direct (sans Maven)
# Ce script compile et exécute directement les tests Java

echo "🌀 AVALON - VALIDATION EXHAUSTIVE (Mode Direct)"
echo "=============================================="
echo ""
...
# Créer un programme Java simple pour tester les formules
echo "📝 Création du testeur simplifié..."

cat > SimpleFormulaValidator.java << 'EOF'
import java.io.*;
import java.util.*;
...
javac SimpleFormulaValidator.java
...
java SimpleFormulaValidator

# Nettoyer
rm -f SimpleFormulaValidator.class SimpleFormulaValidator\$FormulaTest.class
